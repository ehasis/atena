...
void CChefe::Atualizar(TRect area, CObjetoAvancado * const alvo)
{
	...
	{
		if(m_quadro == 35) m_status = eChefeInativo;
...
void CChefe::Desenhar(CTela & tela, int x_real, int y_real)
{
	...
	switch (m_status)
	{
		case eChefeNormal:
			...
			tela.MaskedBlit(m_dados.ObterBitmap(0), eCamadaObjetos, 0, 0, m_x - x_real, m_y - y_real, m_largura, m_altura);
